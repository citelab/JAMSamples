...
int main(int argc, char** argv){
    ...
    nodeID = getId();   //get Unique ID from the cloud
    sendWait = 500;
    receiveWait = 500;

    addDevice();    //increment fog count of devices on the fog where this device is under. Useful for knowing when to stop ML processing logic
